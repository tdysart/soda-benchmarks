...
$(ODIR)/bambu2023/%/05_kernel.c: $(ODIR)/05_llvm_%.ll $(SCRIPTS_DIR)/reference/bambu2023/ll_to_c_cbe.sh
	$(SCRIPTS_DIR)/reference/bambu2023/ll_to_c_cbe.sh $< $@
...
$(ODIR)/bambu2023/%/06_verilog.v: $(ODIR)/bambu2023/%/05_kernel.c $(ODIR)/bambu2023/%/test.xml
	$(BAMBU2023_SETTINGS) \
	$(SCRIPTS_DIR)/reference/bambu2023/c_to_verilog_bambu2023.sh $^ $@
...
$(ODIR)/bambu2023/%/08_sst_results.txt: $(ODIR)/bambu2023/%/06_verilog.v $(SCRIPTS_DIR)/verilator_sst.sh $(SCRIPTS_DIR)/verilator_sst_tb.py
